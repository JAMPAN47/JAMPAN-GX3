...
zokou({
  ...
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr ⦍ᴋᴇʟᴠɪɴ ᴊᴀᴍᴘᴀɴ⦐");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr ⦍ᴋᴇʟᴠɪɴ ᴊᴀᴍᴘᴀɴ⦐ σwnєr");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("thís cσmmαnd ís rєstríctєd tσ thє вσt σwnєr. σr chuga хmd σwnє");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or kelvin jampan owner.* ,,nigga");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or ⦍ᴋᴇʟᴠɪɴ ᴊᴀᴍᴘᴀɴ⦐.* 😎,,idiot");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or kelvin jampan owner.* 😎,,idiot");
  }
...
zokou({
  ...
  // Check if the command is issued by the owner
  if (!superUser) {
    return repondre("*This command is restricted to the bot owner or ⦍ᴋᴇʟᴠɪɴ ᴊᴀᴍᴘᴀɴ⦐ owner.* 😎,,idiot");
  }
