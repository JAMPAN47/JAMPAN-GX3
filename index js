...
if (conf.AUTOREACT_STATUS=== "yes") {
    zk.ev.on("messages.upsert", async (m) => {
        ...
        zk.ev.on("messages.upsert", async (m) => {
            ...
            /* const dj='255674229015';
             const dj2='255674229015';
             const luffy='255674229015'*/
            ...
            console.log("\JAMPAN-GX3 is ONLINE");
...
zk.ev.on('group-participants.update', async (group) => {
    ...
    try {
        ...
        if (group.action == 'add' && (await recupevents(group.id, "welcome") == 'on')) {
            let msg = `*𝐉𝐀𝐌𝐏𝐀𝐍-𝐆𝐗3. 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 𝐈𝐍 𝐓𝐇𝐄 𝐆𝐑𝐎𝐔𝐏 𝐌𝐄𝐒𝐒𝐀𝐆𝐄*`;
    ...
    async  function activateCrons() {
        ...
        zk.ev.on("connection.update", async (con) => {
            ...
            if (connection === "connecting") {
                console.log("ℹ️ JAMPAN-HX3 is connecting...");
            }
            else if (connection === 'open') {
                console.log("✅ JAMPAN-GX3 Connected to WhatsApp! ☺️");
                console.log("--");
                ...
                console.log("Loading JAMPAN GX3 Commands ...\n");
